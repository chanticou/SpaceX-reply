...
const arrayProductos = [
    ...
    new Productos('WOMENS BOMBER JACKET BLACK', 56, 7, 'src=../img/WOMENS_BOMBER_JACKET_BLACK_FRONT_400x.png'),
    new Productos('UNISEX MOTO JAKET BLACK', 150, 8, 'src=../img/UNISEX_MOTO_JACKET_BLACK_FRONT-V2_400x.png')
];